...
{
    public static class GameLogic //static because doesnt need to store data    
    {
        ...
        {//at least 1 ship that is not sunk
            bool isActive = false;
        ...
        public static bool PlaceShip(PlayerInfoModel model, string location)
        {
            ...
            bool output = false;
            (string row, int column) = SplitShotIntoRowAndCollumn(location);
        ...
        public static (string row, int column) SplitShotIntoRowAndCollumn(string shot)
        {
            string row = "";
            int column = 0;
